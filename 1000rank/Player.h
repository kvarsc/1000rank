...
{
public:
	Player() : id(""), tag(""), ranking_score(0.0), uncertainty(0.0), volatility(0.0), rank(0), del(0.0), delold(0.0), vel(0.0) {}
	Player (string id, string tag, double ranking_score, double uncertainty, double volatility) : 
		id(id), tag(tag), ranking_score(ranking_score), uncertainty(uncertainty), volatility(volatility), rank(0), del(0.0), delold(0.0), vel(0.0) {}
